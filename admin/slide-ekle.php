                    ...
                    <div class="card">
                        <div class="body">
                            <form action="islem.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Renkli Başlık</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="slider_renklibaslik" class="form-control"
                                                       placeholder="Renkli başlığı giriniz"/></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="slider_normalbaslik" class="form-control"
                                                       placeholder="Normal başlığı giriniz."/></div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="slider_link" class="form-control"
                                                       placeholder="Linkinizi giriniz."/></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="slider_aciklama" class="ckeditor"
                                                          placeholder="Slayt açıklamasını giriniz"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                                        <button type="submit" name="slider_ekle"
