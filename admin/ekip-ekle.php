            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                            ...
                            <form action="islem.php" method="POST" class="form-horizontal"
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="ekip_isim" class="form-control"
                                                       placeholder="Ekip ismini giriniz"/></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="ekip_facebook" class="form-control"
                                                       placeholder="Facebook adresinizi giriniz"/></div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="ekip_twitter" class="form-control"
                                               placeholder="Twitter adresinizi giriniz"/></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="ekip_linkedin" class="form-control"
                                           placeholder="Linkedin adresinizi giriniz"/></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                        <button type="submit" name="ekip_ekle"
