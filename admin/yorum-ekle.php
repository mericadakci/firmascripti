                            ...
                            <form action="islem.php" method="POST" class="form-horizontal"
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="yorum_isim" class="form-control"
                                                       placeholder="Yorum ismini giriniz"/></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="yorum_meslek" class="form-control"
                                                       placeholder="Meslek giriniz"/></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea name="yorum_aciklama" class="ckeditor"
                                                          placeholder="Yorum açıklamasını giriniz"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
