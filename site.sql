...
DROP DATABASE IF EXISTS `yenifirma`;
...
DROP TABLE IF EXISTS `basarilar`;
...
DROP TABLE IF EXISTS `projelerimiz`;
...
REPLACE INTO `slider` (`slider_id`, `slider_resim`, `slider_renklibaslik`, `slider_normalbaslık`, `slider_paragraf`, `slider_link`) VALUES
...
-- yenifirma.sosyalmedya: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- yenifirma.sponsorlar: ~5 rows (yaklaşık) tablosu için veriler indiriliyor
REPLACE INTO `sponsorlar` (`sponsor_id`, `sponsor_resim`, `sponsor_isim`) VALUES
	(1, 'logo-1.png', 'LOGO 1'),
	(2, 'logo-2.png', 'LOGO 2'),
	(3, 'logo-3.png', 'LOGO 3'),
	(4, 'logo-4.png', 'LOGO 4'),
	(18, '14685794456_15.jpg', 'yeni proje');
...
REPLACE INTO `yorumlar` (`yorumlar_id`, `yorum_resim`, `yorum_isim`, `yorum_meslek`, `yorum_açıklama`) VALUES
