                ...
                <div class="collapse navbar-collapse" id="min_navbar">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu other_dropdwn">
                                <li><a href="hizmet-detay.php">Services</a></li>
                        ...
                        <li><a href="iletisım.php">Contact</a></li>
    ...
    <footer class="footer_area">
        <div class="container">
            <div class="footer_row row">
                ...
                <div class="col-md-3 col-sm-6 footer_about">
                    <h2>Twitter Feed</h2>
                    <a href="#" class="twitter">@themexart: Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat.</a>
                    <a href="#" class="twitter">@themexart: Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat.</a>
                </div>
                <div class="col-md-3 col-sm-6 footer_about">
                    <h2>CONTACT US</h2>
